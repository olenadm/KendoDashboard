...
export const Header = (props) => {
    ...
    const { firstName,avatar, localeId, onLanguageChange } = React.useContext(AppContext);
    ...
    return (
        <header className="header" >
            <div className="nav-container">
                ...
                <div className="title">
                    <img src="/assets/o.png" alt="" className="logo" /><h1>{firstName}'s {localizationService.toLanguageString('custom.warehouse')}</h1>
                </div>
